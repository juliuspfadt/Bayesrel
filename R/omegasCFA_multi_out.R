...
omegasCFA_multi_out <- function(data, n.factors, interval, pairwise, model, model.type, fit.measures) {

  out <- list()
  om_out <- omegaMulti_F(data, n.factors, interval, pairwise, model, model.type, fit.measures)
