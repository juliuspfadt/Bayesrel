...
#' The prior distributions of alpha, lambda2/4/6, and the glb are computed from the
#' prior distribution of the data covariance matrix, which is an inverse Wishart distribution.
#' The prior distribution of omega_u is computed from the prior distributions of the
#' single-factor model parameters. Specifically, a normal distribution for the factor loadings
#' and the factor scores; an inverse gamma distribution for the residuals; and an inverse
#' Wishart distribution for the covariance matrix of the latent variables.
#'
