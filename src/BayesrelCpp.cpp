...
//     * and sets initial values
//     */
//    initsoln2(n_p,nconstraints_p,C2,b,constraints,&X,&y,&Z);
//
//    /*
//     * Solve the problem
//     */
//    status = custom_sdpCpp2(n_p,nconstraints_p,C2,b,constraints,0.0,&X,&y,&Z,&pobj,&dobj);
//
//    /*
//     * Grab the results
//     */
